...
namespace AssetsTools.NET.Extra
{
    public class MonoCecilTempGenerator : IMonoBehaviourTemplateGenerator
    {
        ...
        private volatile bool anyFieldIsManagedReference;

        public volatile string managedPath;
        public ConcurrentDictionary<string, AssemblyDefinition> loadedAssemblies = new ConcurrentDictionary<string, AssemblyDefinition>();
